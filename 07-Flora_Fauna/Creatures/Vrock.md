---
type: creature
classification: Fiend (Demon)
first_appearance: "[[Session 01 — Prisoners of the Underdark]]"
location: "[[Velkynvelve]] — burst from northern passage"
---
...
- Combat with drow guards and chasmes — battle occurred on the outpost platforms above while the party escaped below
...
- The demon incursion provided the distraction that enabled the party's escape
- Amanita sensed the fiendish presence through her spore network

## Significance
- First direct demon encounter in the campaign
- Part of the broader demon lord incursion into the Underdark
- The vrock's arrival at Velkynvelve suggests demon activity spreading through the tunnels
