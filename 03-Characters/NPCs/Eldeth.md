...
- Shield dwarf — no detailed physical description given in S01-S05
- Referred to as "the other dwarf" by DM (S02)
- Per Addison's notes: "Eldeth, a dwarf scout from the city of Gauntlgrym"

## Backstory

- From the dwarven city of [[Gauntlgrym]] (per Addison's notes, 11/22/25)
- Scout by profession

## Abilities

- **Speaks Dwarvish** — the only party member who does (Blarg is a dwarf but does not speak Dwarvish)
- Can help with survival checks (S03: DM confirmed)
- Unfamiliar with this specific region of the Underdark (S03)
