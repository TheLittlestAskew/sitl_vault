...
A small myconid sprout. Uses rapport spores for telepathic communication. Physically growing — showed visible growth during S10 forced long rest. Fungal roots enveloped [[Amanita de'Champignon]] protectively during the rest.

## Backstory

Origin: [[04-World-Lore/Locations/Neverlight Grove]]. A sentient myconid sprout who was imprisoned at Velkynvelve. Bonded with Amanita from S01 via rapport spores.
...
- **Rapport Spores:** Telepathic communication within a short range. Used in combat (S10) — persuasion check 16 to convince Myconid C to stand down.
- **Empowerment Arc:** Sprout developing toward adult transition. DM has indicated this arc is ongoing. Physical growth during S10 forced long rest.
...
- **[[Session 18 — The Big Fish Eat the Little Fish|Session 18]]:** Pitched into the chuul fight — a **Slam (19 to hit) for 1 poison damage**, the chip that brought the [[Chuul]] to 6 HP right before [[Derendil]] devoured it.
...
- "Home is way, way closer now." — S10, in the Feydark [Poignant]
