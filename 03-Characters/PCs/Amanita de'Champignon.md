...
- Wood elf; slender enough that drow shackles were slightly loose — she was able to partially slip a hand through (S02)
- Movement speed: 35ft (S02)
- Eccentric, hippie-mystic demeanor
...
- (S22) **Treats charmed enemies as patients rather than combatants — consistently, and before anyone else does.** They diagnosed the charm on a free Insight, broadcast it to the party, argued the second hag *"isn't even a real hag"*, and ended the session chasing a fleeing hag to talk it down: *"Come on, friend… you just need some water. You need like a little food. You gotta come down from there, man. You're not a hag. Come on, come back to me."* Addison's non-lethal ruling and the "recoverable with careful healing" ruling both hang on this read. — [[Session 22 — Blind Faith in a Hunter's Mark|S22]]
...
- 🛑 **Gap — Sessions 15 through 21 are not written up on this page.** This page's Key Events stop at S14, omitting S15–S20 and the whole of S21 — including the level-5 spherical spore-read of the [[04-World-Lore/Locations/The Darklake|Darklake]] drop-off that spotted the tidal wave, the **Insight 21 that settled [[Derendil]]'s identity for good**, and holding **Pass Without Trace** through the escape. ⚠️ **Wider than the S18–S20 gap previously recorded** — verified 2026-08-29 during the S22 sync. Backfill in a catch-up pass.
- **[[Session 22 — Blind Faith in a Hunter's Mark|Session 22]]:** **The party's diagnostician, and the only person who treats the enemy as patients.** Opened the session above the table with an **in-character "previously on" recap** of S21 and was awarded **heroic inspiration** for it. Read the fog on **Nature 26** — magical, saturated with the hag's conflicting emotions, with *something powerful* happening behind it that could not yet be pierced. Cast **Rapport Spores** ("super groovy edition") to link the party telepathically, which carries the entire session's tactical picture — and later gets weaponised, when both [[Binks Stonevein]]s answer [[Kit Aluri]] through the same link at once.
  Walked *into* the fog bank and on **Arcana 22** traced a mycelial line straight to a hidden point; Addison ruled on that check that the fog was **not [[Nanny Plunk]]'s creation**, though her energy permeated it. Activated **Symbiotic Entity**, mushrooms popping out along their flexed arms. When a merfolk **Skirmisher** speared them, they answered with a **Chill Touch** opportunity attack for 8 necrotic and — on a free **Insight 17** — ⭐ **discovered the merfolk was charmed**, relaying it through the spores: *"Dude, this guy's super high on something. I don't think they know what they're doing."* **That single read reframes the entire encounter** and is what Addison's non-lethal ruling and the "recoverable with careful healing" ruling both hang on. Took **20 cold and prone** from a Wave Bender; burned **Absorb Elements** on the Stormcaller's lightning.
  ⭐ **Round two: 3rd-level Dispel Magic on the fog itself**, cleared on a 19 — **the entire section of fog collapsed**, revealing the first **Stormcaller** channelling a staff, three merfolk, and the second **Green Hag**. Only *two* hags were visible, confirming the party's guess that a third was being made. Cast **Shillelagh**, closed on the hag, dodged an opportunity attack, and **missed with the mithral war pick** even after spending heroic inspiration on the reroll. ⭐ A **natural-20 Insight (25)** — confirmed in the D&D Beyond archive at 14:37 ET — established that the hag in front of them was **certainly a converted merfolk, recoverable with careful healing**, while **Plunk was the focal point**; they broadcast it immediately: *"Guys, we got to take out Nanny. Like, this one's not even a real hag. Just get the big guy."*
  In the wrap-up they chased the nearer green hag — the one they knew had been a merfolk — **trying to talk it down** rather than kill it: *"Come on, friend… you just need some water. You need like a little food. You gotta come down from there, man. You're not a hag. Come on, come back to me."* Cast **Plant Growth**, mycelial tendrils bursting from the azure crystal to lock it in place. **It is still held, and still recoverable.** ✅ 13 DDB archive rolls cross-referenced.

## Key Quotes

- "Oh, well, aren't we all, aren't we all dreaming all the time?" — S01 [Funny]
- "Oh, hey, spider dude. You want to clean this place together?" — S01 [Funny]
...
- "I could shrink you. I could shrink you, and we could put you in a water bottle." — S09, to Glabbagool [Funny]
