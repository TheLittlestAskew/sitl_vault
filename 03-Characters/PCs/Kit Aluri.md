...
- Pragmatic, survivor-oriented, tactical
- Sarcastic, loyal, short-tempered
- Deep Delver background feature — navigation and survival specialist
...
| Item | Status | Notes |
|---|---|---|
| Silvered Crowbar | Active | Iconic item; evolving meaning throughout campaign |
| *[Add items as acquired]* | | |

---

## POV Journal

Kit's first-person memoir is titled **"The Things We Carried in the Dark: A Soldier's Memoir"** and appears in each session's notes.
...
- [[Velkynvelve]] — starting prison location
