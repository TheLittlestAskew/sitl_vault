...
- Very small gnome; blends in with the rocks and caverns due to dirty clothes (S02)
- Bald-headed, stone-colored skin, white goatee (S02)
- Bright smile despite circumstances (S02)
- Movement speed: 25ft (S02)

## Backstory

- Arrived at [[04-World-Lore/Locations/Velkynvelve]] in the same caravan as [[Kit Aluri]] — longest-established bond (S02)
...
- Social, cheerful, resourceful despite grim circumstances
...
- (S22) **Deflects with a joke and then acts anyway.** On finding [[Kit Aluri]] silently unravelling after she stabbed him: *"Well, at least you got her. But I don't really like you not laughing about it. I'm gonna cast Tasha's Hideous Laughter on her."* The joke and the intervention are the same gesture — he had already walked over specifically because she had been asking a lot of questions. — [[Session 22 — Blind Faith in a Hunter's Mark|S22]]

## Abilities & Class Features

- **Invoke Duplicity** (Channel Divinity): Used on Glabbagool (S06)
- **Sneak Attack** (1d6)
- **Blessing of the Trickster:** Grants advantage on stealth. Given to Turvy (S06).
- **Prestidigitation**, **Pass Without Trace**, **Healing Word**, **Augury**
- **Guiding Bolt:** Primary offensive spell. 3 ooze kills in S06, plus double Nat 20 one-shot in S08.
- **Invisibility:** Scout and ambush setup (S06 Combat 2).
- **Thaumaturgy:** Used through Invoke Duplicity (S06).
- **Spiritual Weapon:** Giant glowing lute pick. Non-lethal KO on Turvy (S04). Creative buoy use (S08).
- **Toll the Dead:** Attempted on ooze (S06 — failed).
- **Guidance:** Self-cast for Resurrection check (S09).
...
|---|---|---|
| Ring of Mind Shielding (attuned) | Pre-campaign | Equipped |
| Shield, Chain Shirt, Shortsword | Pre-campaign / S02 | Equipped |
| Hand Crossbow, Holy Symbol | Pre-campaign / S02 | Equipped |
| Enhanced Lute Pick (was personal trinket) | S02 (retained, SoH 21) / S11 (empowered) | **Growth item.** +1 STR. Ring of Mind Shielding properties: immune to thought-reading, lie detection, alignment/type detection. Telepathy only by permission. |
...
- **[[Topsy]] & [[Turvy]]:** Matt rolls for Topsy and Turvy during combat alongside Taylor. Binks advocated for Turvy's survival (S05). In S11, found Topsy alive (resurrected by Carrion King), made healing salve (medicine 24), and brought Kit to see her. Emotional bridge between Kit and Topsy.
- **[[Blarg]]:** Blarg diagnosed and healed Binks after his fall (S06). Provided Help for Resurrection check (S09).
- **[[Darby Stonefeather]]:** Accidentally hit with Guiding Bolt (S06, 8 damage after Stone's Endurance).
- **[[Glabbagool]]:** First contact via Invoke Duplicity + Thaumaturgy (S06).
- **[[Garl Glittergold]]:** Deepening active relationship with his trickster deity.
- **[[Roxanne]]:** Caster of the Resurrection scroll (S09).

## Key Events

- **[[Session 02 — Come Get Your Shit]]:** Formally introduced. Sleight of hand 21 retained trinket. Kit broke his shackles. Leveled to 3.
- **[[Session 03 — Into the Dark]]:** Nearly drowned; rescued by Kit. Cast Pass Without Trace. Spotted hidden dwarven door.
- **[[Session 04 — Life Isn't Faer-zress]]:** Woke first during wererat attack. KO'd Turvy non-lethally with Spiritual Weapon.
- **[[Session 05 — Silvered]]:** Historical context about Blingdenstone wererats. Healed Turvy. Punched Amanita out of madness stun. Cast Augury. Fell/slid down tunnel.
- **[[Session 06 — The Long Way Down]]:** Found at bottom of shaft. Diagnosed and healed by Blarg. **Three gray ooze kills.** Ooze slayer identity established.
- **[[Session 07 — Escape from the Oozing Temple]]:** Highest initiative (23). Scouted ahead. Practically swimming due to small size.
- **[[Session 08 - The Whirlwind and the Depths|Session 08]]:** Spiritual Weapon as buoy. **Double Nat 20 scouting run** — spotted ooze + door (perception), then one-shot ooze (27 radiant crit). 4 total ooze kills.
...
- **[[SITL_10_021526_Echoes_in_the_Feydark|Session 10]]:** Grandfather-vision. Lute pick began empowering. Leveled to 4, multiclassed into Rogue.
- **[[Session 11 — Gifts_of_the_Carrion_King|Session 11]]:** Tried to go back to sleep, believing he was dead. Heard grandfather's voice: "A wise Goliath once told me that your strength comes from your friends." Lute pick empowered (+1 STR, Ring of Mind Shielding properties, growth item). Made healing salve for Topsy (medicine nat 24). Brought Kit to see resurrected Topsy — told Kit "I was struggling with her death, so I knew you probably did, too." Received **Fey Touched** from Psilofyr. Voted Velkynvelve: "I want to settle a score with some drow." Entered Nexus Pool portal.
...
- **[[Session 15 — The Long Road to Sloobludop|Session 15]]:** Scouted on foot at the front of the marching order with [[Kit Aluri]] (7). **Held language classes** for the party teaching Undercommon and Sylvan — his Performance was low (5+4=9), so his students rolled Insight at **disadvantage**, and [[Darby Stonefeather]] still landed a natural 20. Discussed loading [[Aeolus]]'s **Ring of Spell Storing** (3 levels free, Darkness already stored); Shield of Faith, Invisibility, Bless, Disguise Self and Tasha's Hideous Laughter were all floated and **no decision was made**. Took part in the Darkness "safety word" discussion — the word was **not chosen this session**.
- **[[Session 16 — Zone of Truth|Session 16]]:** Took **first watch with [[Topsy]]** (Perception 16 / 8; flat d20 natural 20) and spotted **[[Violet Fungus|violet fungi]]** flashing purple among ordinary-looking growth, plus distant rumbling and a mud-like flow across the path — too far off to threaten. 🛑 **His dream is the session's spine.** Restless since desecrating the Lolth sculpture at [[04-World-Lore/Locations/Velkynvelve]], he dreamt he was *crawling and skittering* through tunnels toward "the one that created this disruption," entering through a hole in a stalactite above a shrine that was **molten, boiling and reshaping itself — "conflicting divine power"** — climbing his target's leg to the neck to strike, and **the turning head showed his own face.** He woke with [[Clementine]] on his shoulder, steady, "as if waiting," and heard in his head: ***"What stand will you take? Which stance will take you?"*** (explicitly **not** a magical effect). A **WIS save of 16 avoided a madness point** — his third dodge; the count stays at 1. A forced **Religion 19** made a distant surge retreat and **diminished** his connection to the Velkynvelve act — he was "protected from something that would have been very, very bad" — but it went **dormant, not away**, and he realised he had been seeing through **arachnid eyes**. In the morning he woke [[Darby Stonefeather]] ("get your spider and keep her away from me"), gathered everyone and cast **Zone of Truth** (15-ft radius, DC 14) — then **failed his own spell**, caught attempting "I am not possessed." Asked *"Am I talking to Binks?"* he answered **"No"**, then clarified: ⭐ **his real name is not Binks** — *"I'm not the guy that I named myself after. I've been the same person through and through."* First confirmation the name is assumed. ⚠️ **[[Derendil]] passed the save, and only Binks knew it.**
- **[[Session 17 — The Big Fish Eat the Little Fish|Session 17]]:** Carried the party's **only remaining point of madness** into the session (Kit, Aeolus, Blarg and Darby had all been cleared), and took **1 level of exhaustion** from the sleepless nights. Opened the chuul ambush with a **2nd-level Guiding Bolt for 20**. After [[Derendil]]'s frenzy dropped [[Kit Aluri]] to 0, he **topped her back up for 9** behind [[Blarg]]'s Cure Wounds.
- **[[Session 18 — Trust the Whirlpool|Session 18]]:** Steered from [[Roxy]]'s horns through the river run and **spotted the mid-channel boulder — and the "mermaid" standing on top of it — too late** (Perception 18), shouting to ask [[Sloopidoop]] whether mermaids are friendly (*"I do not think so"*) and then simply "Boulder!" ⭐ **His Guiding Bolt is what won the fight.** Cast with advantage on the grappled hag for **16 damage**, it **dropped her Disguise Self** and left her glowing for the next attacker — which set up [[Kit Aluri]]'s natural-20 killing leap. Took 7 bludgeoning in the whirlpool and ended the session at a point of exhaustion.
- **[[Session 19 — We Are Split in Two|Session 19]]:** ⭐ **Talked the party out of a battle.** Ashore and surrounded by nine hostile kuo-toa, he used **Thaumaturgy to project his voice**, apologised for the intrusion, and invoked [[Sloopidoop]]'s name and the token he had been given — **Persuasion with disadvantage, ~23 even after exhaustion** — then backed it with a **second Persuasion of 21** aided by Heroic Inspiration, which got two of the four remaining guards to stand down. The party was escorted in hostile but unharmed. Inside the netting gate, when [[Indigo]]'s faction ambushed their captors, he **cast Invisibility to slip away and was caught anyway** — ⚠️ **the kuo-toa here can sense invisible creatures**, which is new tactical information. Rolled history on [[Bregan D'aerthe]] during the [[Artaxle]] flashback. At the cliffhanger he volunteered instantly to go in as bait — *"I love trickery — yes, I'll do it"* — leaving one bystander with a cryptic parting whisper: *"it was the little statue."*
- **[[Session 20 — Not My Circus, Not My Demogorgon|Session 20]]:** **Insight 23** on the bound duergar read him as a smuggler-trader who had walked into the wrong town after the Deep Father faction rose — later revealed as **[[Hemeth]]**. In round one he **channelled divinity to create an illusory duplicate of himself atop the shrine**, making "the most obscene gestures" as a distraction (a combined Deception/Performance reported as 39 — the numbers are garbled but it was ruled a success): whips and monitors turned toward the double, and **it survived a monitor's bite.** He then slipped behind [[Derendil]]. In round two he cast **Bless on [[Darby Stonefeather]], [[Amanita de'Champignon]] and [[Aeolus]]** through a window. At the hard stop, **down to a single spell slot**, he floated desecrating the ritual and a gloriously cheeky **Ceremony** gambit to turn the lake around [[Demogorgon]] into holy water — Addison: *"That'd be like a DC 30 Religion check."* On the escape route he was unequivocal: ***"I ain't splitting the party."***
- **[[Session 21 — The Shield and the Middle Finger|Session 21]]:** Took a **fourth Cleric level and the Skill Expert feat** (expertise in Insight, proficiency in Deception), then prayed out loud — *"Please, give me wit. Give me cleverness, [[Garl Glittergold|Garl]]"* — and rolled a **31 on a combined Religion+Insight check**. Addison **tripled his stunt doubles, made them semi-corporeal and golden, and able to speak through him.** He went first in the carried-over initiative and used **Thaumaturgy through all his duplicates** to boom an evacuation order in Undercommon across the whole town — *"Sloobludop is lost. The demon is coming to destroy this place… Your lives are more important. We have to leave"* — then followed it with a **26 Persuasion**, and the town started running. His persuasion to bring [[Jimjar]] and [[Hemeth]] along **failed**. The tidal wave flung him into a dock for **10 bludgeoning**. 🛑 **The session's centrepiece is his.** He hung back at the mist line to watch [[Sloobludop]] die — *"the second town he held in his heart that has been destroyed"* — and said a prayer for the kuo-toa dead. **He rolled an 8.** Addison had built the moment so the party could help him; [[Kit Aluri]] passed the high-DC Perception needed to notice, refused to name a god, and cleared **DC 30** on his behalf — and **his last remaining duplicate solidified into a golden shrine to [[Garl Glittergold]]** wearing Binks's own face, posture and robes, holding a shield out toward [[Demogorgon]] and humming in a low sing-song voice that reminded him of *Kit*. **He immediately added a raised middle finger to the statue's other hand.** Addison noted there may be consequences later. Rolled a **dirty 20 on History** for the full [[04-World-Lore/Locations/Mantol-Derith]] briefing (⚠️ a *total* of 20 — natural 18; see [[Roll Statistics S16-S25]]). Scavenged and patched the second hull with [[Blarg]]'s help and guidance. **Rolled a natural 1 on the bone-teeth group Dexterity check** — *"Don't worry, I'm kind of an anchor"* — and went over the side into the whirlpool; [[Indigo]] surfaced and hauled him back aboard. ✅ **27 DDB archive rows — the session's heaviest**, but ⚠️ **inflated by [[Topsy]]/[[Turvy]] proxy saves** rolled on Matt's account as composite `2d20` customs.
- **[[Session 22 — Blind Faith in a Hunter's Mark|Session 22]]:** Opened above the table having **reconciled the party inventory on D&D Beyond** — 1,800 gp including the platinum, a string of pearls and healing potions, deliberately left undivided: *"it's a communist party at this point. We're all sharing."* Read [[Nanny Plunk]] on **Insight 25**: threat level very high, her hurt and anger a **deliberate affect**, and — the detail that mattered — **she is alone**, which hags are not. When [[Indigo]] finally admitted the cove held innocent merfolk and Tritons, Binks landed the session's first big laugh: *"you really buried the lead there. If you would have just led with that, we would not been having this conversation."*
  In combat his **Spiritual Weapon** was established on-air as **an actual lute** played like an electric guitar — Addison: *"It's not a pick. It is an actual lute."* It missed in round one and *"bangs onto the rock and just emits this BANGING electrical riff,"* then hit for 8 in round two behind a 2nd-level **Guiding Bolt**. He stated his objective plainly: ***"My goal is to kill Nanny Plunk."***
  **Then he became the weapon against his own friend.** The hags shimmered and [[Kit Aluri]] saw two of him; when she asked how many there were, he answered *"Currently? There's two. The one behind the hag and the one me"* — and both Binkses replied to her telepathically at once through the Rapport Spores, which is precisely what made the illusion convincing. Told she was about to be stabbed, he said only ***"Do it."*** After she killed the hag through the illusory copy and turned to him with *"your Binks,"* **he flipped her off.** Then, unprompted, he walked over to check on her, recognised the short-term madness behind her questions, made a joke of it — *"well, at least you got her. But I don't really like you not laughing about it"* — and cast ***Tasha's Hideous Laughter*** on her to stop her attacking anyone. **That is the closing image of the session.** ✅ 11 DDB archive rolls cross-referenced.

## Key Quotes

- "Can you break me out my shackles first?" — S02 [Funny]
- "I'd rather jump, so that's what I'm gonna do." — S02 [Funny/Decisive]
- "Bad, but could be fun." — S05, Augury result [Funny/DM Quip]
- "I guess I'm made to kill slimes. It's pretty good." — S06 [Funny]
- "Oh, hey, guys. Thanks for coming." — S06 [Funny]
- "I guess I'm just really good at killing things that don't have bones." — S08 [Funny]
- "I killed slimes and almost drowned. I did not level up." — S09 [Banter]
- "I want to go through the portal so bad." — S09 [Funny]
- "I'm still trying to figure out if we're dead." — S11 [Poignant]
...
> ✅ **Gap CLOSED 2026-08-29.** The S15–S21 Key Events for this page were backfilled from the session notes in a dedicated catch-up pass; the sessions listed here as missing are now written up above. *Superseded — kept as a record of when the gap existed and when it was filled.*
