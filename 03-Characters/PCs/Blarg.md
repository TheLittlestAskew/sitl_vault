...
*Note: Florian is from Germany; speaks English with a heavy accent. Account for speech-to-text errors in transcripts.*

---

## Description / Appearance

- Dwarf — no detailed physical description given in S01-S09 beyond standard dwarf build
...
- Cheerful, content, philosophically detached — treats imprisonment like a minor inconvenience
- Genuinely delighted by identifying Zurkhwood as edible mushroom wood (nature 26, S01)
...
- **Goblin Wild Shape (S11 homebrew):** Can use wild shape charge to become a goblin. Keeps own stats but gains goblin appearance and Fury of the Small. Duration: 1 hour (per DM). Empowered by Chris (fae goblin leader).
- **Tremorsense (Dwarf racial):** 60 ft for 10 minutes, bonus action. Must be on stone.
...
- **Moonbeam (2nd level):** Radiant damage AoE. Used S06 Combat 3 on oozes B+C. Used S08 on Black Pudding (30 total).
- **Cure Wounds:** 2nd level, 23 HP on Amanita (S03). 8 HP on Turvy (S05). 15 HP on Binks (S06). 19 HP on Kit (S08).
- **Healing Word:** Healed Aeolus in pool (S03).
- **Help Action:** Provided Help to [[Binks Stonevein]] for Resurrection scroll check (S09).
- **Herbalism Kit:** Proficient. Used S06 alongside medicine check.
- **Medicine:** 25 on Binks (S06) — diagnosed TBI, burst eardrums.
- **Arcana:** 22 on Glabbagool (S06). 25 (23 adjusted) on Feydark portal (S09).

## Inventory / Loot

| Item | Session Acquired | Status |
|---|---|---|
| 100-foot coil of rope | S02 (chose from barracks morning loot) | Carried |
| D4 (4) trinket table items | S02 (rolled 4; D100 rolls pending) | TBD — DM to resolve |
...
- **[[Kit Aluri]]:** Healed Kit to full (19 HP) after Relentless Endurance (S08). Observed Kit's character growth re: Topsy (S09).
- **[[Aeolus]]:** Bonded through shrine combat ordeal (S01-S02).
- **[[Amanita de'Champignon]]:** Followed her to elite barracks (S02). Healed her 23 HP (S03). Received Longstrider (S07).
- **[[Turvy]]:** Compassionate. Discussed burial rites (S06 retcon). Gave moon flask (S05).
- **[[Binks Stonevein]]:** Diagnosed and healed after fall (S06). Provided Help for Resurrection check (S09).
- **Chris (Fae Goblin Leader):** Met in Feydark (S11). Chris recognized Blarg by scent and carving. Knew Carbra. Empowered carving. Permanent goblin tribe welcome.
- **Carbra (Adoptive Goblin Shaman):** Blarg's adoptive parent. Referenced in S11. Location unknown.
- **[[Darby Stonefeather]]:** Darby caught Blarg during descent (S06).
- **Clementine (Darby's tarantula):** Saluted with one spider leg when wild shaped (S06).

## Key Events

- **[[Session 01 — Prisoners of the Underdark]]:** Introduced as cheerful prisoner. Nature 26 identified Zurkhwood. Perception 23 in shrine. Poison Spray vs spider.
- **[[Session 02 — Come Get Your Shit]]:** Wild shaped into wolf. Nat 20 strength to break Amanita's shackles. Dropped torch into webbing. Leveled to 3.
- **[[Session 03 — Into the Dark]]:** Swam to Amanita. Healed her 23 HP. Killed gray ooze with radiant bolt. Healed Aeolus with Healing Word.
- **[[Session 04 — Life Isn't Faer-zress]]:** Cast Hold Person on Turvy, paralyzing him.
- **[[Session 05 — Silvered]]:** Found moon flask. Gave to Turvy. Spoke privately about loss. Healed Turvy 8 HP.
...
- Bathed at the pool, then anchored the party's buffs in **Combat 1**: cast **Bless** on [[Kit Aluri]], [[Aeolus]], and [[Amanita de'Champignon]]; **Animal Handling 20** to read the [[Chuul]]'s ~10 ft reach.
- **Perception 15** heard [[Sloopidoop]] approaching after Derendil ate the chuul.
- In **Combat 2**, **Persuasion (disadvantage) 16** partly calmed the frenzied [[Derendil]]; his readied **Hold Person failed** — Derendil is a monstrosity, not a Humanoid (see [[House Rules & Rulings]]). Still vouched for Derendil ("saved her life twice").
...
- "I haven't been raised by my family." — S03 [Poignant]
