...
- [ ] Travel to Sloobludop — 7 days travel from Velkynvelve (corrected from 8, S15). Days 1–4 covered in S15 (Fungal Cavern found Day 4). **S16: Night camp at the Fungal Cavern (watches: violet fungi + carrion crawler sighted, no combat), then Days 5–6 travel out of the cavern. Party ends S16 ~1 day from Sloobludop, officially in the Darklake region.** (S14–S16)
...
- [ ] **The Horn / Roxy Storage (S16)** — Ritual partially drew [[Roxanne]] into "the horn" (Darby 12 + Aeolus 23 vs DC 25 for full benefits). Learned: storage is possible, a retry may keep her in, and "something else" inside is controllable. Interference from nested dimensional magic (Roxy's saddlebags) + Faerzress. ⚠️ **Horn origin/name established in lost pt1 recording — [Unknown/Ambiguous], ask DM for recap.** Pt1 DDB rolls (Darby History 8/Arcana 3, Blarg Arcana 16, Kit Arcana nat-20 22) likely the identification scene.
...
- [ ] **Derendil's Curse — Break It (S16)** — Derendil sleep-"hunted" on all fours, self-torn clothes, no memory. Named his curser: **the evil wizard Terrestor** (usurped his High Forest throne). Asked the party to find a way to break the curse; he doesn't know its nature. **He passed the Zone of Truth save — only Binks knows.** No detectable lies spoken.
