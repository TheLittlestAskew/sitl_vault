...
- [ ] Travel to Sloobludop — 7 days travel from Velkynvelve (corrected from 8, S15). Days 1–4 covered in S15 (Fungal Cavern found Day 4). S16: night camp at the Fungal Cavern, then Days 5–6 travel out of the cavern; party ends ~1 day from Sloobludop, in the Darklake region. **S18 (Day 6): the [[Darklake Approach Pool]] — fishing, chuul ambush, Derendil's frenzy, first contact with [[Sloopidoop]]. Sloobludop now "a short day's walk" away; party departing for the final leg.** (S14–S18)
...
- [ ] **Derendil's Curse — Break It (S16) / Darkening (S18)** — Derendil sleep-"hunted" on all fours, self-torn clothes, no memory (S16). Named his curser: **the evil wizard Terrestor** *(rendered "Pterostor"/"terroristor" in S18 — same entity, divergent DM renderings; do not silently reconcile)*. **S18: [[Sloopidoop]] debunks the story** — Derendil "is no elf" but a chaos-deluded **quaggoth** with a false memory, and "there is no cure besides the peace of death." Sloopidoop knows the High Forest and has never heard of the kingdom **"Nel Rinden Vain"** nor the wizard. Derendil then **frenzied, devoured the chuul, and dropped Kit to 0** before being Slept and **bound** (+1 exhaustion). Now an active intra-party danger; the "curable noble" hope is curdling toward "no cure but death."
  - *Sub-thread:* **Verify Derendil's identity / kingdom** — *Likely false (S18).* "Nel Rinden Vain" / "Nil Ren" / "Nell Wind in Vain" unverifiable; Sloopidoop has never heard of it.
- [ ] **Ally with the Society of Brilliance / aid Sloopidoop's village (S18)** — *New, opened.* Mutual-aid bargain with [[Sloopidoop]] ([[Society of Brilliance]]): escort him to [[Sloobludop]] and help defend it against the worsening chaos, in exchange for knowledge and aid. He gave a village-access bead and identified the party's loot. He names a mind flayer colleague, [[Wazalax]] *(name unresolved)*, and confirms the chaos is **intensifying** (Society's primary study). Party hinted at a fey/death-imbalance theory tied to [[Silofirst]].
- [ ] **The Sea Mother (S18)** — [[Sloopidoop]] worships "knowledge" and a sea deity whose name he voices as a deliberate, **untranslatable kuo-toa gurgle** — recorded as "the Sea Mother [Unknown/Ambiguous gurgled name]." Canonical identification NOT asserted in-note (no metagaming). Not Lolth (he reacts to Lolth with anger).
- [ ] **Spell Scroll of "Sand" identity (S18)** — Recovered 1st-level spell scroll identified by Sloopidoop as "Sand," but no standard 1st-level spell of that name exists. Confirm intended spell with DM before use.
- [ ] **Kuo-toa scale armor classification (S18)** — Recovered teeth/shell scale armor (non-metal; usable by Amanita). Medium vs. heavy classification + stealth penalty DM-pending ("I'll have to look at that").
...
- [ ] Darkness Safety Word — Party agreed they need a coordinated safety word for when Aeolus casts Darkness. Meaning: "get close to Aeolus." Word not yet chosen. **Raised again S18 among Aeolus's open concerns — still unresolved.** (S15–S18)
- [ ] "Clementine" — open continuity datum (S18) — [[Aeolus]] lists "what are we doing about Clementine?" among open concerns; **no context surfaces in S18.** [[Clementine]] appears in S16 as [[Darby Stonefeather]]'s spider tied to Binks/Lolth. Cross-reference whether this is the same Clementine or a separate concern. (S16, S18)
