...
- [ ] **Level 5 at Sloobludop — DM granted level-up agency (S16): upon reaching Sloobludop, each player may take the next level at any narratively-chosen moment, even mid-combat. ⚠️ Note: the Completed list below says "Level-Up to 5 (between S12-S13)" but S15 notes record Party Level 4 — reconcile with DM which level is pending.**
