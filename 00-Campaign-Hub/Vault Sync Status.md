...
1. ✅ **DONE 2026-08-29 — the PC-page gap is closed. All six PC pages now run continuously S01→S22** (bar two legacy holes, below). **34 entries were backfilled** from the session notes in a dedicated catch-up pass; every inline `⚠️ Gap` marker on a PC page is now marked closed.
   ...
   ⚠️ **Two legacy holes remain and are out of this pass's scope:** [[Kit Aluri]] has no **S11** entry and [[Binks Stonevein]] has no **S01** entry. Both predate S15 and were not audited here.
   🔵 Still outstanding from the S20 partial sync: **S20 House Rules** and **S20 Open Threads**.
2. 🔵 **Two NPC pages still carry live S18–S20 gap markers:** [[Roxy]] (the S18 twin-raft form, S19 shore approach and shrine offering, S20 stampede) and [[Derendil]] (S19–S20). Not touched by the PC-page pass.
3. ⚠️ **Resolve the S17/S18 session-number collision** (human decision) and retire duplicate 06/07/2026 transcripts/pipeline folders.
