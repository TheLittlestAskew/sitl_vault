...
party_present: ["Kit Aluri", "Amanita de'Champignon", "Darby Stonefeather", "Aeolus", "Blarg"]
...
| Session Number | 01 |
| Session Date | 10/12/2025 |
| Start Location | [[04-World-Lore/Locations/Velkynvelve]] — Prison Cell |
| End Location | [[04-World-Lore/Locations/Velkynvelve]] — Various locations across outpost |
...
[[Jorlan Duskryn]] approaches [[Kit Aluri]] at night and offers to leave the cell unlocked during the next guard shift. Kit learns via history check (nat 20) that Jorlan was [[Ilvara Mizzrym]]'s former lover, replaced by [[Shoor Vandree]].
...
The session ends as a vrock bursts from the northern passage chased by chasmes, and [[04-World-Lore/Locations/Velkynvelve]] erupts into chaos.

---

## Locations Visited

- [[04-World-Lore/Locations/Velkynvelve]] — Prison Cell (anti-magic field)
- [[04-World-Lore/Locations/Velkynvelve]] — Guard Posts (North, South, Central)
- [[04-World-Lore/Locations/Velkynvelve]] — Barracks
- [[04-World-Lore/Locations/Velkynvelve]] — Shrine to [[Lolth]]
- [[04-World-Lore/Locations/Velkynvelve]] — Main Hall / Kitchen
- [[04-World-Lore/Locations/Velkynvelve]] — Armory (Central Guard Tower)
- [[04-World-Lore/Locations/Velkynvelve]] — Quaggoth Den (referenced)
- [[04-World-Lore/Locations/Velkynvelve]] — Platform Lift

---

## Quests / Objectives

- **Escape Velkynvelve** — (In Progress) [[Jorlan Duskryn]] will leave the cell unlocked during the next guard shift.
- **Recover Confiscated Gear** — (In Progress) Gear believed to be in the armory.
- **Lift Aeolus's Spider Curse** — (New, Open) Cursed by [[Lolth]]'s gemstone. Requires Remove Curse or returning gem to a drow worshipper.
- **Find Shuushar** — (Open) [[Shuushar]] fell into the pool; whirlpool observed. Fate unknown.
- **Find Jimjar** — (Open) [[Jimjar]] disappeared overnight.
- **Buppido's Fate** — (Presumed Dead) Sacrificed to spiders, fell into pool.
