...
type: location
region: Underdark (Northdark)
first_appearance: "[[Session 01 — Prisoners of the Underdark]]"
---

# Velkynvelve

Drow outpost and prison suspended on stalactite platforms over a deep cavern in the Underdark. Opening location of the Out of the Abyss campaign and the Sky Is The Limit campaign.

## Description

The outpost consists of multiple stalactite platforms connected by bridges made of Zurkhwood and silk cord. A waterfall cascades from a massive hole in the rock face into a pool at the cavern floor below. There is no natural light; illumination comes from faint purple phosphorescence, magical torchlight, and bioluminescent veins in the rock.

## Key Areas

- **Prison Cell** — Large communal cell on a stalactite platform; anti-magic field suppresses spellcasting within the cell
...
- **[[Jorlan Duskryn]]** — Drow Elite Warrior. **Alive (S13).** Turncoat — aided party in S01-S02 and S13. Shot Ilvara with crossbow.
