...
###### - 10/12/25![[Shushar stool topsy turvy.png]]![[jimjar ront sarith.png]]
	...
	- [Shuushar] was knocked off the rope bridge by [Ront] in his rage, calmly falling into the water to also disappear.
	- Finally, [Ront] was sacrificed to the giant spiders after attempting to kill a guard on the bridge.

	- The remaining NPC prisoners with you are:
	- [Eldeth], a dwarf scout from the city of [Gauntlgrym]
	- [Sarith], a quiet and grim Drow accused of murdering another [drow] - often holds his head as if in pain and mutters to himself
	- [Stool], the [myconid] sprout trying to find it's way "home"
	- [Derendil], the [guaggoth] who is wearing clothing and speaks [Elvish], claims to have been polymorphed by a curse.
...
###### - 11/09/25
	- **Session 3 - “Taking the Plunge” - 11/9/25**
		...
		- As this shared moment of euphoria fades, the party, feeling refreshed, revitalized, and alert, notice that they are not exactly free yet. Binks and Aeolus begin to sink rapidly, unable to immediately swim to the surface. Kit managed to reach for Binks and they resurfaced together. 

			- **[Darby]**, still carrying two [zhirkwood] chests full of loot, sinks immediately to the bottom of the pool another 20 feet below the surface. She feels the pull of a colder undercurrent, but weighed down by her gear, her muscles, and her force of will, starts calmly walking along the bottom, up to the shallows. However, she slips on something slimy and slick on the otherwise rock and sand bottom. In everyone’s ears, they hear a gurgling telepathic voice exclaim, “FLESH! Flesh for the Faceless Lord!”, as an enormous [Gray Ooze] rises from the depths to greet the party.
			- **[Binks]**, at the surface but seeing Aeolus in peril, channeled his divine powers to send a healing word to him. 
			- **[Amanita]** sent a Chill Touch along with a Halo of Spores to weaken the Ooze, but the Ooze, sensing the threat, immediately retaliated with a huge and elongated blob-arm, hurting Amanita badly and leaving acidic ooze to eat away at their clothes and flesh.
			- **[Kit]**, crawling up the slick rocky bank of the pool with Binks, fueled by a rush of adrenaline and determination to not lose another ally, helped to pull Darby away from the Ooze to safety.
			- **Aeolus**, after sending a couple blasts of Elritch energy at the Ooze, quickly swam to shore and was able to spot the three exits to the wide cavern. 
			- **[Darby]**, now safe and dry, lashed at the Ooze with her whip, finally making the Ooze rethink its choices in trying to make of meal of our heroes. 
		- As the [Ooze] began to retreat back into the pool, **[Blarg]** swam to Amanita and gave them some healing before sending a bolt of radiant light right into the central mass of the Ooze. Lifeless, the goop denatured and sank into the depths.
		- Seeing that they had reached the center of the cavern and the [Drow] still clashing with the [Demons] above, the party quickly made their escape into the Northern passageway. They ran through the tunnels for nearly two hours before finally stopping to rest, exhausted. After catching their breaths, drinking some water, and taking a quick stock of their current inventory, the group felt that (at least for the time being) they were not being pursued by their [Drow] captors. Staying careful, [Binks] sent a calming magic through the rock and earth around the party as he cast Pass Without Trace. They pressed on, though at a more moderate pace.
...
###### - 11/22/25
	...
	- [Jimjar] was taken away but nobody saw or really heard what happened to him. Our players who were in [Velkynvelve] long enough to have seen him could make a skill check to see if you got a clue
	...
	The four that are with you are:
	1) Eldeth the Dwarven scout
	![[eldeth.png]]
	2) Stool the Myconid Sprout
	![[stool.png]]
	3) Topsy and Turvy, the Deep Gnome twins.![[topsy_and_turvy.png]]
...
###### - 12/23/25
	- Session 5: "Safe is Good" - 12/7/25, day 2 post-Velkynvelve
		...
		- A debate ensues between Kit’s pragmatic desire to eliminate a potential threat and Darby’s pacifist stance. Binks provides historical context on were-rats in Blingdenstone, noting that the twins likely did not choose their condition. After Binks heals Turvy, the were-rat reveals that the shifting Faerzress energy caused their loss of control. Amanita confirms the presence of corrupted magic using Detect Magic, which briefly sends her into a hallucinatory madness before Binks punches her back to her senses.
...
###### -061826
**Doll of the Fallen Soldier (Lvl 5 Upgrade)**

- HP = 6d8 + CON mod + STR mod + Proficiency Bonus.
- Doll has the Animated Armorstat block.
- Your Doll has 3 charges per day that recharge over a long rest - instinctual understanding that the summoning magic will not be impossible but may have chaotic consequences if you attempt to spend a " 4th charge".
- Attacks against you have disadvantage while the Doll is within 5 feet of you. The Doll enters initiative when summoned and takes it's first turn immediately.
- The Doll has full movement while carrying you.
- All effects end if the Doll reaches 0HP, but the Doll possesses Orcish Endurance.

	**Abilities (Priorities) of the Doll:**

	1. **Get up**: 1 charge - Triggers automatically when you reach 0HP the second time - Doll enlarges and uses its full movement and the dash action to pick you up and carry you the shortest route away from danger.
	2. **Get the Fey-k Out**: 2 charges - Doll uses your Fey Step ability (Fey-Touched) to fey-step you or an ally the Doll can touch to an area you can see within range of the spell.
	3. **Fight Me**: 1-2 charges - Doll enlarges and casts Compel Duel on a single enemy. Can expend a 2nd charge to cast it on a second enemy.
	4. **I. said. Get. UP.**: Uses all remaining charges (2 minimum) - Doll heals you for 2d8 + prof. bonus + STR + CON mod, and uses Second Wind to enlarge and either move you or take one action, including _Compel Duel_ and _Fey Step_
	5. **Shapeshifter's Bane** - +1 Magical Greatsword
		1. Requires attunement by a Battlemaster Fighter - **Soul Bound to Kit Aluri**
		2. Once per day, You can use your bonus action or burn a superiority die to grant the greatsword the properties and appearance of another melee or thrown weapon in your inventory or one that you have previously wielded. The greatsword cannot shift into shields or ammunition-based weapons.
		3. The greatsword can shift into other magical weapons in your inventory or that you are currently attuned to, but magical affects do not stack.
		4. On a hit while the weapon is in a different form, the weapon may either do base greatsword damage OR damage type and die of the shifted weapon.
		5. When Duel-wielding with this weapon shifted into to a one-handed weapon, attacks require a STR saving throw (DC20-STR modifier).
		6. You can use bonus action to re-summon the greatsword back to you as long as you can see it.
###### - 070526
